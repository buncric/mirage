...
#define SPOOF_VER_PLIST jbroot(ROOT_PATH_NS(@"/var/mobile/Library/Preferences/com.buzizaa.mirage.plist"))
#define SPOOF_VER_OLD_PLIST jbroot(ROOT_PATH_NS(@"/var/mobile/Library/Preferences/com.0xkuj.3dappversionspoofer.plist"))
#define SPOOF_VER_TWEAK_BUNDLE @"com.buzizaa.mirage.shortcut"
#define SPOOF_VER_SETTINGS_CHANGED_NOTIFICATION CFSTR("com.buzizaa.mirage.settingschanged")
